...
class Clients(models.Model):
    ...
    type_client = models.SmallIntegerField(db_column='Type_Client', blank=True, null=True)  
...
class Sites(models.Model):
    ...
    type_site = models.SmallIntegerField(db_column='Type_Site', blank=True, null=True)  

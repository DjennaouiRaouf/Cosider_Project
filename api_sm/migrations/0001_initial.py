    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('num_situation', models.PositiveIntegerField(blank=True, default=0)),
                ...
                ('montant_taxe', models.DecimalField(decimal_places=2, default=0, editable=False, max_digits=38, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Montant Retenue de garantie')),
                ('montant_rb', models.DecimalField(decimal_places=2, default=0, editable=False, max_digits=38, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Montant Retenue de garantie')),
                ('a_payer', models.DecimalField(decimal_places=2, default=0, editable=False, max_digits=38, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Net à Payer')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deleted', models.DateTimeField(db_index=True, editable=False, null=True)),
                ('deleted_by_cascade', models.BooleanField(default=False, editable=False)),
                ('montant_rg', models.DecimalField(decimal_places=2, default=0, editable=False, max_digits=38, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Montant de la retenue de garantie')),
        ...
        migrations.AddField(
            model_name='avance',
            name='client',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='Avance_Client', to='api_sm.clients'),
        ),
        migrations.AddField(
            model_name='avance',
            name='marche',

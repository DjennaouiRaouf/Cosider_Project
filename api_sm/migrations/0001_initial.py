# Generated by Django 3.2.22 on 2023-11-07 14:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ht', models.DecimalField(decimal_places=2, default=0, editable=False, max_digits=10, validators=[django.core.validators.MinValueValidator(0)])),
                ('ttc', models.DecimalField(decimal_places=2, default=0, editable=False, max_digits=10, validators=[django.core.validators.MinValueValidator(0)])),
                ...
                ('date_modification', models.DateTimeField(auto_now=True, db_column='Date_Modification')),
                ('marche_initial', models.ForeignKey(blank=True, db_column='marche_initial', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='api_sm.marche')),

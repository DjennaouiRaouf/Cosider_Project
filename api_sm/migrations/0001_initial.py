# Generated by Django 3.2.22 on 2023-11-08 14:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('taux', models.DecimalField(decimal_places=2, default=0, max_digits=10, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)])),
                ('date_modification', models.DateTimeField(auto_now=True, db_column='Date_Modification')),
                ('user_id', models.ForeignKey(db_column='User_ID', editable=False, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tva', models.DecimalField(decimal_places=2, default=0, max_digits=10, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('montant', models.DecimalField(decimal_places=2, default=0, editable=False, max_digits=10, validators=[django.core.validators.MinValueValidator(0)])),
                ('est_recupere', models.BooleanField(default=True, editable=False)),
                ('date_modification', models.DateTimeField(auto_now=True, db_column='Date_Modification')),
                ('banque', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='api_sm.marche')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('montant', models.DecimalField(decimal_places=2, default=0, max_digits=10, validators=[django.core.validators.MinValueValidator(0)])),
                ('date_modification', models.DateTimeField(auto_now=True, db_column='Date_Modification')),
                ('Client', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='Avance_Client', to='api_sm.marche')),
                ('marche', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='Avance_Marche', to='api_sm.marche')),
                ('type', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='api_sm.typeavance')),
                ('user_id', models.ForeignKey(db_column='User_ID', editable=False, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]

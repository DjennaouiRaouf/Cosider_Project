    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('H', 'Header'), ('F', 'Footer'), ('EH', 'Empty Header'), ('EF', 'Empty Footer')], max_length=20, unique=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mode_paiement', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.DO_NOTHING, to='api_sm.modepaiement')),
            ],
            options={

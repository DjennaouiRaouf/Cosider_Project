...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('numero_facture', models.CharField(blank=True, max_length=500)),
                ('date_facture', models.DateField(auto_now=True)),
                ('annulation', models.BooleanField(default=False)),
                ('attachements', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='api_sm.attachements')),
            ],
            options={

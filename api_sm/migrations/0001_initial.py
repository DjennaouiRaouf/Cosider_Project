    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_change_reason', models.CharField(max_length=100, null=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('code_client', models.ForeignKey(blank=True, db_column='Code_Client', db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='api_sm.clients', verbose_name='Code du client')),
                ...
                ('code_situation_nt', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='api_sm.situationnt', verbose_name='Situation')),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.AddField(
            model_name='factures',
            name='marche',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='api_sm.marche'),
        ),
        migrations.CreateModel(
            name='DQE',
            fields=[

    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payer', models.BooleanField(default=False, editable=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('deleted', models.DateTimeField(db_index=True, editable=False, null=True)),
                ('deleted_by_cascade', models.BooleanField(default=False, editable=False)),
                ('code_marche', models.CharField(editable=False, max_length=500, primary_key=True, serialize=False, verbose_name='Code du marché')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('deleted', models.DateTimeField(db_index=True, editable=False, null=True)),
                ('deleted_by_cascade', models.BooleanField(default=False, editable=False)),
                ('nt', models.CharField(db_column='NT', max_length=20, primary_key=True, serialize=False, verbose_name='Numero du travail')),
                ...
                ('code_client', models.ForeignKey(db_column='Code_Client', null=True, on_delete=django.db.models.deletion.CASCADE, to='api_sm.clients')),
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'historical Situation du Travail',
                'verbose_name_plural': 'historical Situation du Travail',
                'ordering': ('-history_date', '-history_id'),
                'get_latest_by': ('history_date', 'history_id'),
            },
            bases=(simple_history.models.HistoricalChanges, models.Model),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('deleted', models.DateTimeField(db_index=True, editable=False, null=True)),
                ('deleted_by_cascade', models.BooleanField(default=False, editable=False)),
                ('nt', models.CharField(db_column='NT', db_index=True, max_length=20, verbose_name='Numero du travail')),
                ('libelle_nt', models.CharField(blank=True, db_column='Libelle_NT', max_length=900, null=True)),
                ('date_ouverture_nt', models.DateField(blank=True, db_column='Date_Ouverture_NT', null=True)),
                ('date_cloture_nt', models.DateField(blank=True, db_column='Date_Cloture_NT', null=True)),
                ('history_id', models.AutoField(primary_key=True, serialize=False)),
                ...
                ('code_site', models.ForeignKey(blank=True, db_column='Code_site', db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='api_sm.sites', verbose_name='Code du Site')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('deleted', models.DateTimeField(db_index=True, editable=False, null=True)),
                ('deleted_by_cascade', models.BooleanField(default=False, editable=False)),
                ('code_marche', models.CharField(db_index=True, editable=False, max_length=500, verbose_name='Code du marché')),
                ('num_avenant', models.PositiveIntegerField(default=0, editable=False, verbose_name='Avenant Numero')),
                ('libelle', models.CharField(blank=True, max_length=500, verbose_name='Libelle')),
                ('ods_depart', models.DateField(blank=True, verbose_name='ODS de départ')),
                ('delais', models.PositiveIntegerField(default=0, verbose_name='Delai')),
        ...
        migrations.AddField(
            model_name='dqe',
            name='marche',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='marche_dqe', to='api_sm.marche'),
        ),
        migrations.CreateModel(
            name='Cautions',
            fields=[

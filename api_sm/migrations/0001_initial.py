# Generated by Django 4.2.7 on 2024-01-14 12:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('taux_avance', models.DecimalField(decimal_places=2, default=0, editable=False, max_digits=38, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)])),
            ],
            options={
                'verbose_name': 'Avance',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('deleted', models.DateTimeField(db_index=True, editable=False, null=True)),
                ('deleted_by_cascade', models.BooleanField(default=False, editable=False)),
                ('id', models.CharField(db_column='Code_Banque', max_length=15, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('banque', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='api_sm.agence')),
        ...
        migrations.AddField(
            model_name='agence',
            name='banque',
            field=models.ForeignKey(db_column='Code_banque', on_delete=django.db.models.deletion.DO_NOTHING, to='api_sm.banque'),
        ),
        migrations.CreateModel(
            name='Encaissement',
            fields=[
                ...
                ('banque', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='api_sm.agence', verbose_name='Banque')),

# Generated by Django 4.2.7 on 2023-12-16 20:32
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dqe', models.CharField(blank=True, max_length=500, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('deleted', models.DateTimeField(db_index=True, editable=False, null=True)),
                ('deleted_by_cascade', models.BooleanField(default=False, editable=False)),
                ('code_unite_mesure', models.PositiveBigIntegerField(db_column='Code_Unite_Mesure', editable=False, primary_key=True, serialize=False)),
                ('symbole_unite', models.CharField(blank=True, db_column='Symbole_Unite', max_length=10, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code_situation_nt', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='api_sm.situationnt', verbose_name='Situation')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('marche', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='api_sm.marche')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deleted', models.DateTimeField(db_index=True, editable=False, null=True)),
                ('deleted_by_cascade', models.BooleanField(default=False, editable=False)),
                ('montant_rg', models.DecimalField(decimal_places=2, default=0, editable=False, max_digits=38, validators=[django.core.validators.MinValueValidator(0)])),
                ('facture', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='api_sm.factures')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('est_tache_composite', models.BooleanField(blank=True, db_column='Est_Tache_Composite', null=True)),
                ('est_tache_complementaire', models.BooleanField(blank=True, db_column='Est_Tache_Complementaire', null=True)),
                ...
                ('marche', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='marche_dqe', to='api_sm.marche')),

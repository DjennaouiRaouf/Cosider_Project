# Generated by Django 3.2.22 on 2023-11-07 08:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ht', models.DecimalField(decimal_places=2, max_digits=10, validators=[django.core.validators.MinValueValidator(0)])),
                ('ttc', models.DecimalField(decimal_places=2, editable=False, max_digits=10, validators=[django.core.validators.MinValueValidator(0)])),
                ...
                ('numero_marche', models.ForeignKey(db_column='numero_marche', on_delete=django.db.models.deletion.DO_NOTHING, to='api_sm.nt')),
                ('user_id', models.ForeignKey(db_column='User_ID', editable=False, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
